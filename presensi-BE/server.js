...
try {
  // Ambil sertifikat yang sudah dibuat oleh generate-ssl.js
  const options = {
  ...
  https.createServer(options, app).listen(PORT, () => {
    console.log(`🔒 Server aman berjalan di https://localhost:${PORT}`);
  });
} catch (error) {
  console.error("❌ Gagal menjalankan server HTTPS. Apakah folder/file SSL sudah dibuat?");
